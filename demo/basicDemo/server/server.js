...
const validCommands = ["UP", "DOWN", "LEFT", "RIGHT", "ENTER"];
...
console.log(
  "Please visit controller side on:",
  `http://localhost:${SERVER_PORT}/controller`
);
console.log(
  "Please visit controlled side on:",
  `http://localhost:${SERVER_PORT}/controlled`
);
